    ...
    <div className='about'>
        ...
        <div className='intro'>
           <p className='intro__parraf'>
               ...
               <p className='intro__parraf__p'>I'm  Web Developer and I have knowledge of ⇢ <span className='intro__parraf__p__name'> HTML5, JavaScript, CSS/SASS, React, MySQL </span>and basic knowledge of APIs and backend programming in applications with Node.js, Express.js.</p>
               <p className='intro__parr
               af__p'>Currently I'm looking for a new challenge where I can continue learning and improve my skills and knowledge. I have experience working within a scrum and agile metodologies.</p>
