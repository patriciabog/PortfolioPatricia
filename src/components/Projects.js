            ...
            <div className=' projects'>
                   <article className='projects__article'>
                        ...
                        <div className='content'>
                             ...
                             <p className='projects__article__p'>This web app has been created to assist with finance management by recording all income and expenses over a span of three months. The graphic displays the changes over time. By clicking the orange button, users can add a new transaction using a form. Built with: HTML5, CSS, JavaScript, Vue.js, Git</p>
                        </div>
                ...
                <article className='projects__article'>
                    ...
                    <div className='content'>
                        ...
                        <p className='projects__article__p'>This is a memory game for kids, excellent to train your brian, have planets images and sounds. Built with: HTML5, CSS, JavaScript, GIT</p>
                    </div>    
                    <div className='projects__article__links'>
               ...
               <article className='projects__article'>
                    ...
                    <div className='content'>
                        ...
                        <p className='projects__article__p'>This web application was developed using APIs. After clicking the 'Get Started!' button, you can access a list of people. You have the option to filter the list by gender and age or search by name. Built with: HTML5, CSS/SCSS, JavaScript, React,npm, GIT</p>
                    </div>    
                    <div className='projects__article__links'>
               ...
               <article className='projects__article'>
                    ...
                    <div className='content'>
                       <h4 className='projects__article__title'>Harry Potter </h4>
                             <p className='projects__article__p'>This web page has been developed using APIs of Harry Potter characters that can be filtered by name and/or house. Built with: HTML5, CSS/SCSS, JavaScript, React, npm, GIT</p>
                    </div>
                    <div className='projects__article__links'>
                ...
                <article className='projects__article'>
                    ...
                    <div className='content'>
                         <h4 className='projects__article__title'>Awsome Cards </h4>
                             <p className='projects__article__p'> This is a team project. An interactive web application has been created where you can design and create a personalized digital business card. It is a cost-effective and environmentally friendly solution as it eliminates the need for paper. Built with: HTML5, CSS/SCSS, JavaScript, GIT</p>
                    </div>
                    <div className='projects__article__links'>
                ...
                <article className='projects__article'>
                    ...
                    <div className='content'>
                         <h4 className='projects__article__title'>Guess the Number </h4>
                             <p className='projects__article__p'>In this game, you have to try to guess the number. Below, you can see how many attempts you have made. If your guess is incorrect, you can try again. Built with: HTML5, CSS/SCSS, JavaScript, GIT</p>
                    </div>     
                    <div className='projects__article__links'>
                ...
                <article className='projects__article'>
                    ...
                    <div className='content'>
                         ...
                         Built with: HTML5, CSS/SCSS, JavaScript, React, MySQL Workbench, FreeDB, Zeplin, Git/GitHub, Gulp, Node.js, Express.js. </p>
                    </div>     
                    <div className='projects__article__links'>
